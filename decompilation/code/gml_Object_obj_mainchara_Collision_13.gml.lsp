...
0x000044:
    if !(== (collision_point[]:int32 (var 1s) (var 0s) (var 820s) (+ self.bbox_bottom 3s) (- self.bbox_left 3s)) -4s) goto 0x0000C4
0x000090:
...
0x0000E8:
    if !(== (collision_point[]:int32 (var 1s) (var 0s) (var 820s) (- self.bbox_top 3s) (+ self.bbox_right 3s)) -4s) goto 0x000168
0x000134:
    self.x = (+ self.xprevious 3s)
    self.y = (- self.yprevious 3s)
    goto 0x000178
