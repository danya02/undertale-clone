...
0x0001B8:
    push (!= self.sprite_index (real[]:int32 (var 2009s)))
    goto 0x0001DC
0x0001D8:
    push 0s
0x0001DC:
...
0x0001F8:
    if !(== global.faceemotion 6s) goto 0x00022C
0x00020C:
...
0x00024C:
    if !(== global.faceemotion 7s) goto 0x000280
0x000260:
...
0x0002A0:
    if !(== global.faceemotion 8s) goto 0x0002D4
0x0002B4:
...
0x0002F4:
    if !(== global.faceemotion 9s) goto 0x000328
0x000308:
...
0x000348:
    if !(bool (instance_exists[]:int32 (var 782s))) goto 0x000398
0x000360:
    if !(!= 782.halt 0s) goto 0x000384
0x000374:
    self.image_speed = 0s
    goto 0x000398
0x000384:
