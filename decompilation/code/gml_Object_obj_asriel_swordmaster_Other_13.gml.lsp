...
0x000020:
    self.x = (+ self.x 1s)
    if !(< self.x (+ self.thisx 25s)) goto 0x000080
0x000058:
...
0x0000A0:
    self.x = (+ self.x 2s)
    if !(< self.x (+ self.thisx 25s)) goto 0x000100
0x0000D8:
...
0x000120:
    self.x = (+ self.x 2s)
    if !(< self.x (+ self.thisx 25s)) goto 0x000180
0x000158:
...
0x0001A0:
    self.x = (+ self.x 3s)
    if !(< self.x (+ self.thisx 25s)) goto 0x000200
0x0001D8:
