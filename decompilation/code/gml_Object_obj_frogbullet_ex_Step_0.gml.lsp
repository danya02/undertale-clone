...
0x000014:
    push self.x
    if !(< -5s (+ 0s:idealborder 15s)) goto 0x0000E0
0x00003C:
    self.active = 0s
    self.side = 1s
    push -5s
...
0x0000E0:
    push self.y
    if !(< -5s (+ 2s:idealborder 15s)) goto 0x0001AC
0x000108:
    self.active = 0s
    self.side = 2s
    push -5s
...
0x0001AC:
    push self.x
    if !(> -5s (- 1s:idealborder 15s)) goto 0x000278
0x0001D4:
    self.active = 0s
    self.side = 3s
    push -5s
...
0x000278:
    push self.y
    if !(> -5s (- 3s:idealborder 15s)) goto 0x000344
0x0002A0:
    self.active = 0s
    self.side = 0s
    push -5s
